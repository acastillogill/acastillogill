...
full_maps%>%
  ...
  coord_flip()+
  scale_y_continuous(labels=comma_format())+
  labs(title="Top 10 by R downloads per capita in 2017/18",
       x="",
       y="Downloads")+
  theme(legend.position = "none")+
...
In this post I analysed a dataset that contained downloads of R software around the world spanning a one year period between 2017 and 2018. Using the `tidyverse`, `lubridate`, and `tmap`packages, I found out which countries download the software the most. Since large countries with large populations will have more total downloads, I decided to inspect number downloads per capita. This extra step revealed that small, developed countries, such as Hong Kong, Switzerland, Iceland, Singapore, Liechtenstein, the Netherlands and Denmark have the most downloads per capita. An exception to this were the US and Australia with at least one download per capita despite being larger countries. Lastly, I looked into which months had the most R downloads by sub-regions and found that almost everywhere, there are few R downloads during the summer. 
