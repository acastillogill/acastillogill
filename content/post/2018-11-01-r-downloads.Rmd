...
```{r plot-downloads-per-capita-map, include=TRUE, fig.cap="Besides the top 10 downloads per capita plot, here we see that Uruguay and Chile in South America have the most downloads per capita; Costa Rica in Central America; and Japan in Asia."}
n_capita_map
```
