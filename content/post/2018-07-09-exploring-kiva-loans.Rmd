...
```{r sectors-and-continents, fig.cap="In every continent, the three most popular sectors are agriculture, retail, and food.",fig.width=15}
...
```{r countries-plot, fig.cap="Philippines requests the mosts loans with over double as the second country, Kenya `KE`. Other top countries in this ranking are Cambodia `KH`, Pakistan `PK`, Peru `PE`, Colombia `CO`, Uganda `UG`, Tajikistan `TJ`, Ecuador `EC`, and Paraguay `PY`.", fig.width=17}
