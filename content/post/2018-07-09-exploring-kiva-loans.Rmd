...
```{r continent_and_borrower_genders_plots, fig.height=2, fig.cap="Most popular borrower genders by continent"}
...
```{r repayment_interval_and_continent, fig.height=2, fig.cap="Most popular repayment styles by continent"}
...
```{r sectors_and_continents, fig.height=2, fig.cap="Most popular uses of loans by continent"}
...
```{r countries_plot, fig.height=2, fig.cap="Top 10 countries requesting Kiva loans"}
kiva_loans %>%
