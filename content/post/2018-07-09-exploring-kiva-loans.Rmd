...
```{r continent-and-borrower-genders-plots, fig.cap="Most popular borrower genders by continent",fig.width=12}
...
```{r repayment-interval-and-continent, fig.cap="Most popular repayment styles by continent",fig.width=12}
