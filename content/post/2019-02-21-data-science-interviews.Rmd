...
As a data scientist there are statistics, programming, and application basics you should know. Now, here is where I could have done things differently. During the last few months I had focused on re-writing manuscripts, enjoying the Christmas/New Year break and planning moving countries. I am a firm believer of: "if you don't use it, you lose it."
...
## Rehearse not knowing, or being wrong, and feeling embarrased and STILL speaking with confidence

The main feedback I've received when I give public speeches is that my voice sounds a bit monotonous and that I speak too fast. Wanting to improve, last year I joined Toastmasters Barcelona and I improved so much in terms of pausing, entonation, rythym.

There is one thing however, that I did not practice and that I should have, and that is being wrong, being called out on being wrong, knowing they're right on you being wrong, and still CRACKING ON WITH CONFIDENCE. This is a skill for a lifetime.
...
Adopting some sort of persona and putting a mask on for the one or two hours that the interview asks 

## Have a mentor to support you along the way

A couple of month before moving, I thought it would be interesting to get some commercial data science experience. Through R-Ladies I met Raquel Redó, a data scientist based in Barcelona. Although the timing wasn't right for me to try to engage 
