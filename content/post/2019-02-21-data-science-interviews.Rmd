...
So to the best of my abilities, I try to track all my work. I do this to constantly update my learning loop and efficiently allocate time. I tried to extend this to my job search by tracking as many activities as possible. Here is the key for the tasks I show along with a commentary on my usage. 
...
This is basically everything related to sending e-mails to arrange phone calls, or interviews, and towards the end, going over the final job offer, signing and posting it. Signed, sealed, delivered, I'm yours `r emo::ji("musical_note")`!
