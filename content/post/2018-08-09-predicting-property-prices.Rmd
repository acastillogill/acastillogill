...
```{r compute correlations with response variable}
...
Some numeric variables can actually be better interpreted as factors, these are: `OverallQual`, `ExterQual`, `KitchenQual`, `BsmtQual`, `FullBath`, `GarageFinish`, `TotRmsAbvGrd`, and `FireplaceQu`.
