...
subtitle: "In what regions does the model perform best?"
author: Ángela Castillo-Gill
date: '2018-12-13'
slug: checking-model-fit
categories:
  - Journal
tags: 
  - Learning
draft: FALSE
summary: "In what regions does the model perform best?"
output:
 blogdown::html_page:
  fig_caption: true
editor_options: 
...
```{r plot-model-fit}
models_augmented%>%
  ggplot(aes(x=users, y=n))+
  geom_point(alpha=0.5)+
  geom_point(aes(y=.fitted), color="red", alpha=0.5)+
