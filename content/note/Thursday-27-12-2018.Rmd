---
title: "Skeleton for blogpost"
subtitle: "Let's write it up"
author: Ángela Castillo-Gill
date: "`r format(Sys.Date())`"
slug: skeleton-for-blogpost
categories:
  - Journal
tags: 
  - Learning
draft: FALSE
summary: "Let's write it up"
output: 
 blogdown::html_page:
  fig_caption: true
editor_options: 
...
In this blogpost I want to look at everything I've written and document what I would like to include in the blogpost. 

I would like to include what months of the data have the most R-Downloads. 
...
```{r plot-what-months-have-the-most-downloads}
...
```{r read-iso-country-codes}
iso_codes <- read_csv(here::here("static","data","iso_countries.csv"))
```

```{r merge-iso-country-codes}
