---
title: "When do countries download R?"
subtitle: "Examining when Namibia downloads R the most"
author: Ángela Castillo-Gill
date: '2018-12-17'
slug: when-do-countries-download-r
categories:
  - Journal
tags: 
  - Learning
draft: FALSE
summary: "Examining when Namibia downloads R the most"
output:
 blogdown::html_page:
  fig_caption: true
editor_options: 
...
```{r plot-model-fit}
models_augmented%>%
  ggplot(aes(x=users/1000, y=n, shape=cut(HDI, breaks = 4)))+
  geom_point(alpha=0.5)+
...
So I'm intrigued why Namibia has the most R-Software downloads per capita, let's look at when in the year they download the software the most. 
