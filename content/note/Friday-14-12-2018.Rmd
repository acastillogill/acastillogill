---
title: "Improving facets"
subtitle: "Modifying facet scales"
author: Ángela Castillo-Gill
date: '2018-12-14'
slug: improving-facets
categories:
  - Journal
tags: 
  - Learning
draft: FALSE
summary: "Modifying facet scales"
output:
 blogdown::html_page:
  fig_caption: true
editor_options: 
...
There seems to be a great fit for Asian countries. Let's see how many countries there are in Asia. 
```{r counting-countries-in-Asia}
full_hdi%>%
  filter(region=="Asia")%>%
  count()
```
